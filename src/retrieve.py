...
If there are multiple answers, arbitrarily choose the one that fits best.
...
def getPieceLocation(database_results):
    try:
        print("ANSWER STARTS")
        graph = Neo4jGraph(url=neo4j_url, username=neo4j_user, password=neo4j_password)
    ...
    if user_input:
        with st.spinner("Processing your question..."):
            ...
            try:
                ...
                try:
                    getPieceLocation(database_results)
